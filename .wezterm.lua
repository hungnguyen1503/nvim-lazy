...
local default_cwd = "C:/Users/a5134005/hungquangnguyen/REDACTED"
...
config.launch_menu = {
    ...
    {
        label = 'Install package for REDACTED',
        args = { 'bash', 'C:\\Users\\a5134005\\hungquangnguyen\\REDACTED\\08_Tutorial\\REDACTED.sh' },
    },
    {
        label = "SSH to Pi RX (REDACTED)",
        args = { "ssh", "rvc@10.231.9.131" },
    },
    {
        label = "SSH to Coder HCM1 (REDACTED)",
        args = { "ssh", "coder.REDACTED" },
    },
    {
