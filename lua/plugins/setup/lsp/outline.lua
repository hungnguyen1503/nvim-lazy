...
local options = {
    ...
    symbols = {
        ...
        -- Optional custom function returning an icon per kind; nil = use the
        -- icons table below. (Note: it must be a direct child of `symbols`.)
        icon_fetcher = nil,
        ...
        -- Icons use codicon glyphs (U+EA80-U+EBFF) verified present in
        -- CaskaydiaCove Nerd Font 3.2.1; the previous math-alphanumeric and
        -- emoji glyphs (𝓒 ℰ 𝓐 ⊨ ⦿ 🔐 𝓢 🗲 𝙏) rendered as tofu.
        icons = {
